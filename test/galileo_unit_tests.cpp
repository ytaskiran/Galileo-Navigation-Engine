...
TEST(GalileoPageTest, WordType1)
{
    ...
    GalileoPage<WordType::EPHEMERIS_1, UbxSigId::None> gal_page_1_test{};
    ...
    EXPECT_EQ(gal_nav_data_test.eph[svId-1].Toe, 474000);
...
TEST(GalileoPageTest, WordType2)
{
    ...
    GalileoPage<WordType::EPHEMERIS_2, UbxSigId::None> gal_page_2_test{};
    GalileoNavData gal_nav_data_test{};
...
TEST(GalileoPageTest, WordType3)
{
    ...
    GalileoPage<WordType::EPHEMERIS_3, UbxSigId::None> gal_page_3_test{};
    GalileoNavData gal_nav_data_test{};
...
TEST(GalileoPageTest, WordType4)
{
    ...
    GalileoPage<WordType::EPHEMERIS_4_CLOCK_CORRECTION, UbxSigId::None> gal_page_4_test{};
    GalileoNavData gal_nav_data_test{};
    ...
    EXPECT_EQ(gal_nav_data_test.eph[svId-1].Toc, 474000);
...
TEST(GalileoPageTest, WordType5)
{
    ...
    GalileoPage<WordType::IONOSPHERIC_CORRECTION_BGD_SIG_HEALTH_DVS_GST, UbxSigId::None> gal_page_5_test{};
    GalileoNavData gal_nav_data_test{};
...
TEST(GalileoPageTest, WordType6)
{
    ...
    GalileoPage<WordType::GST_UTC_CONVERSION, UbxSigId::None> gal_page_6_test{};
    GalileoNavData gal_nav_data_test{};
...
/*TEST(GalileoPageTest, WordType7E5b)
{
    ...
    GalileoPage<WordType::ALMANAC_1, UbxSigId::E5b> gal_page_7_test{};
    GalileoNavData gal_nav_data_test{};
